...
[![Status](https://img.shields.io/badge/status-P4%20Planned-6366F1)](https://github.com/dclawstack/dclaw-fleet)
[![Stack](https://img.shields.io/badge/stack-Next.js%2014%20%2B%20FastAPI%20%2B%20PostgreSQL-purple)](https://docs.dclawstack.io/apps/fleet)

---

## Overview

DClaw Fleet is an AI-native logistics application. It follows the standard DClaw architecture:
...
DClaw Fleet uses the **DKube Design System** with its app-specific brand color.
...
```bash
git clone https://github.com/dclawstack/dclaw-fleet.git
cd dclaw-fleet
```
...
export DATABASE_URL="postgresql+asyncpg://postgres:postgres@localhost:5432/dclaw_fleet"
...
```bash
ssh root@your-vps
git clone https://github.com/dclawstack/dclaw-fleet.git /opt/dclaw-fleet
cd /opt/dclaw-fleet
docker compose up -d
```

The app will be available at `https://fleet.dclawstack.io`.
...
helm upgrade --install dclaw-fleet . \
...
- [Docs](https://docs.dclawstack.io/apps/fleet)
